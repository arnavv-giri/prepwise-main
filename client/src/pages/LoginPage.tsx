  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-primary/6 blur-3xl" />
        <div className="absolute bottom-0 -left-32 h-64 w-64 rounded-full bg-accent-yellow/6 blur-3xl" />
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 relative">
        <div className="w-full max-w-md animate-scale-in">
          ...
          {/* Gradient top bar */}
          <div className="h-1 w-full rounded-t-2xl bg-gradient-to-r from-[hsl(24,95%,45%)] via-[hsl(35,98%,55%)] to-[hsl(42,88%,50%)]" />
          ...
          <div className="bg-card border border-border border-t-0 rounded-b-2xl p-8 space-y-8
            ...
            <div className="space-y-2 text-center">
              ...
              <p className="text-muted-foreground text-sm">
                Sign in to continue to PrepWise
              </p>
            </div>
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link to="/register" className="text-primary hover:text-accent-blue transition-colors font-medium">
                Create account
              </Link>
            </p>
